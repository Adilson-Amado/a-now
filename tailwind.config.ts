  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "can-wait": {
          DEFAULT: "hsl(var(--can-wait))",
          foreground: "hsl(var(--can-wait-foreground))",
        },
        dispensable: {
          DEFAULT: "hsl(var(--dispensable))",
          foreground: "hsl(var(--dispensable-foreground))",
        },
        // Productivity states
        productive: "hsl(var(--productive))",
        partial: "hsl(var(--partial))",
        unproductive: "hsl(var(--unproductive))",
      },
      borderRadius: {
        lg: "var(--radius)",
